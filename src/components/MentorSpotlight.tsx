...
export const MentorSpotlight: React.FC<MentorSpotlightProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/80 backdrop-blur-md overflow-y-auto animate-fadeIn">
      <div className="relative w-full max-w-4xl bg-slate-900 border border-amber-500/30 rounded-2xl shadow-2xl shadow-amber-950/40 overflow-hidden flex flex-col max-h-[92vh]">
        
        {/* Glowing Gold / Amber Banner Header */}
        <div className="relative bg-gradient-to-r from-amber-950 via-slate-900 to-amber-950 p-6 border-b border-amber-500/30 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 via-amber-600 to-yellow-700 p-0.5 shadow-xl shadow-amber-500/20 shrink-0 flex items-center justify-center">
              ...
              <div>
                ...
                <h1 className="text-xl sm:text-2xl font-black font-mono text-white mt-1 flex items-center gap-2">
                  Trader Abdullah Masood
                  <span className="text-xs font-mono font-normal text-amber-400/90 bg-amber-950/60 px-2 py-0.5 rounded border border-amber-800/60">
            ...
            <a
              ...
              className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-mono text-xs font-bold flex items-center justify-center gap-2 shadow-lg shadow-red-950/50 transition-all shrink-0 hover:scale-105 active:scale-95 group"
            >
          ...
          <div className="flex items-center gap-2 mt-6 pt-4 border-t border-slate-800/80 overflow-x-auto scrollbar-none">
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-mono font-semibold transition-all flex items-center gap-2 shrink-0 ${
                activeTab === 'tribute'
            ...
            >
              ...
              Key Mentorship Curriculum & Masteries
            </button>
            <button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {activeTab === 'tribute' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-gradient-to-br from-amber-950/40 via-slate-900 to-slate-900 border border-amber-500/40 rounded-xl p-6 relative overflow-hidden shadow-xl">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <blockquote className="text-sm sm:text-base text-slate-200 font-sans leading-relaxed italic border-l-2 border-amber-500 pl-4 py-1">
                  ...
                  <div className="pt-2 flex flex-wrap items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-500 text-white font-mono text-xs font-bold flex items-center gap-2 shadow-lg shadow-red-950/50 transition-all"
                    >
                      <Youtube className="w-4 h-4 fill-current" />
                    ...
                    <button
                      onClick={() => setActiveTab('curriculum')}
                      className="px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-amber-300 border border-amber-500/30 font-mono text-xs font-semibold flex items-center gap-2 transition-all"
                    >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-4 hover:border-amber-500/40 transition-colors space-y-2">
                  ...
                  <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-4 hover:border-amber-500/40 transition-colors space-y-2">
                    <div className="flex items-center gap-2 font-mono text-xs font-bold text-yellow-300">
                      <div className="w-6 h-6 rounded-lg bg-yellow-500/20 text-yellow-400 flex items-center justify-center text-xs">
                        2
                      </div>
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs font-mono font-bold text-white">Study Chapter 23 in the Digital Bible</div>
                    <div className="text-[11px] text-slate-400">Complete breakdown of Abdullah Masood&apos;s Daily Bias & Gold SMC Playbook</div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 rounded-lg bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono text-xs font-bold flex items-center justify-center gap-2 transition-all shrink-0"
                >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Curriculum structure taught across 800+ comprehensive lectures on @TraderAbdullahMasood
                  </p>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-mono text-amber-400 hover:text-amber-300 flex items-center gap-1.5 underline"
                >
              ...
              <div className="grid grid-cols-1 gap-4">
                {keyCurriculumTracks.map((track, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 hover:border-amber-500/40 transition-all space-y-3"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="px-2 py-0.5 rounded text-[9px] font-mono font-bold tracking-wider bg-slate-900 border border-slate-700 text-slate-400">
                              {track.tag}
                            </span>
                            <h4 className="text-sm font-bold font-mono text-white mt-0.5">{track.title}</h4>
                          </div>
                        </div>
                        ...
                        {onSelectConcept && (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-amber-300 border border-amber-500/30 font-mono text-xs flex items-center gap-1.5 transition-colors"
                          >
                      ...
                      <div className="bg-slate-900/60 rounded-lg p-3 border border-slate-800/80 space-y-1.5">
            ...
            <div className="space-y-5 animate-fadeIn">
                  ...
                  return (
                    ...
                    >
                      <div className={`w-5 h-5 rounded-md flex items-center justify-center mt-0.5 transition-colors shrink-0 ${
                        isChecked ? 'bg-amber-400 text-slate-950' : 'border border-slate-600 bg-slate-900'
                      }`}>
                        {isChecked && <Check className="w-3.5 h-3.5 stroke-[3]" />}
                      </div>

                      <div className="flex-1">
                        <div className="text-[10px] font-mono font-bold text-amber-400/90 uppercase tracking-wider">
                          {item.category}
                        </div>
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3.5 py-1.5 rounded-lg bg-red-600 hover:bg-red-500 text-white font-mono text-xs font-bold flex items-center gap-2 transition-colors"
                >
        ...
        <div className="bg-slate-950 px-6 py-4 border-t border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onClose}
              className="px-4 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 font-mono font-bold transition-colors"
            >
              Close
            </button>
          </div>
